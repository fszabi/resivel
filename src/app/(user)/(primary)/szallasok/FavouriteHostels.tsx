...
const FavouriteHostels = () => {
  ...
  return (
    <div className="relative mt-14 space-y-4">
      <Subheading>Kedvenc szállásaid</Subheading>
      {isOverflowing && (
        <button
      ...
      >
        ...
        >
          <p>Budapest szállás</p>
          <Avatar className="size-24" src={budapest} />
        </Link>
        <Link
          href="/barbermaster"
          className="min-w-[14rem] max-w-[18rem] space-y-2 rounded-lg bg-zinc-300/30 p-4 dark:bg-zinc-700/30"
        >
          <p>Pécs szállás</p>
          <Avatar className="size-24" src={pecs} />
        </Link>
        <Link
          href="/barbermaster"
          className="min-w-[14rem] max-w-[18rem] space-y-2 rounded-lg bg-zinc-300/30 p-4 dark:bg-zinc-700/30"
        >
          <p>Balaton szállás</p>
          <Avatar className="size-24" src={balaton} />
        </Link>
        <Link
          href="/barbermaster"
          className="min-w-[14rem] max-w-[18rem] space-y-2 rounded-lg bg-zinc-300/30 p-4 dark:bg-zinc-700/30"
...
export default FavouriteHostels
