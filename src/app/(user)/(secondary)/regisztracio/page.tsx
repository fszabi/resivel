  ...
  return (
    <SlimLayout>
      ...
      <form className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
        <TextField label="Vezetéknév" name="first_name" type="text" autoComplete="given-name" required />
        <TextField label="Keresztnév" name="last_name" type="text" autoComplete="family-name" required />
